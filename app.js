...
// Speech Recognition Engine - Mobile Fixed Real-time Stream
function initSpeechEngine() {
    ...
    recognition.onresult = (e) => {
        ...
        let liveView = confirmedTranscript;
        if (interim) {
            liveView += `${getDiarizedPrefix()} <span style="opacity: 0.7;">${interim}</span>`;
        }

        output.innerHTML = highlightKeywords(liveView);
